...
export const ZONES = [
...

  {
    ...
    physics: { maxSpeed: 40 },
    sky: [
      [0.00, '#2a1030'], [0.24, '#7a2f52'], [0.44, '#e0663f'],
      [0.60, '#ffab54'], [0.78, '#ffe0a8'], [1.00, '#c98a52'],
    ],
    fog: { color: '#e8a468', near: 200, far: 380 },
    sun: { color: '#fff0c8', intensity: 2.6 },
    hemi: { sky: '#ffd0a0', ground: '#5a3520', intensity: 0.5 },
    backdrop: { sun: '#fff6d8', halo: '#ff8a3a', arc: '#e8b890', planet: '#8a5a3a' },
    colors: {
      road: '#6b4a30',
      kerb: '#e8c898',
      deck: '#c89a68',
    ...
    facades: ['#d8ab78', '#c08f5e', '#e8c496', '#a87850', '#d0a070', '#bf9464'],
    props: {
      road: 'street',
...

  {
    ...
    mechanic: 'Bumpers pay out. For once, hitting things is the idea.',
    built: true,
    length: 2200,
    ...
    props: {
      road: 'street',
      walls: true,
      // Every block in the authored phrases becomes a bumper.
      bumpers: true,
      obstacleKit: { barrier: 'fence', gate: 'gantry', block: 'pillar' },
...

  {
    id: 'foundry',
    name: 'THE FOUNDRY',
    subtitle: 'WHERE THE RING IS POURED',
    mechanic: 'Conveyor lanes. Green carries you, red fights you.',
    built: true,
    length: 2900,
    track: 'audio/sugar-crash-core.mp3',
    physics: { startSpeed: 20, maxSpeed: 46, speedRamp: 0.22 },
    sky: [
      [0.00, '#140a04'], [0.28, '#3d1c06'], [0.5, '#7a3a08'],
      [0.68, '#c46a10'], [0.84, '#ffb84a'], [1.00, '#241004'],
    ],
    fog: { color: '#7a3a08', near: 150, far: 300 },
    sun: { color: '#ffd8a0', intensity: 1.8 },
    hemi: { sky: '#ffa860', ground: '#1a0c04', intensity: 0.46 },
    backdrop: { sun: '#fff2c8', halo: '#ff9a20', arc: '#b06a30', planet: '#5a2a10' },
    colors: {
      road: '#2a1c12',
      kerb: '#5a4028',
      deck: '#3a2616',
    ...
    facades: ['#4a3018', '#5c3a1c', '#3a2412', '#6a4422', '#2e1c0e', '#553618'],
    props: {
      road: 'street',
      walls: true,
      obstacleKit: { barrier: 'slab', gate: 'pipe', block: 'press' },
      arches: 'gantry', archEvery: 18, archTint: ['#ff6a10', '#ffb02e'],
